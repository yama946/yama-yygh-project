...
import com.yama.yygh.hosp.repository.ScheduleRepository;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        Schedule targetSchedule = scheduleRepository.findScheduleByHoscodeAndHosScheduleId(schedule.getHoscode(), schedule.getHosScheduleId());
        if(null != targetSchedule) {
            //值copy不为null的值，该方法为自定义方法，如此进行更新排班信息
